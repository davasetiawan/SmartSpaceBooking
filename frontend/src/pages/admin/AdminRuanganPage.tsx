...
import { Building2, Plus, Edit2, Trash2, CheckCircle2, XCircle, Search } from 'lucide-react';
import { api, Ruangan } from '../../services/api';

export const AdminRuanganPage: React.FC = () => {
  ...
  return (
    <div className="admin-ruangan-root">
      ...
      <style>{`
        ...
        .room-cell small { display: block; color: var(--text-secondary); font-size: 0.75rem; }
